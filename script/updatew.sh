...
sed "s/^full://g;s/^regexp:.*$//g;s/^/nameserver \//g;s/$/\/direct/g" -i /tmp/temp_direct
cat /tmp/temp_direct > conf/domain-set/direct-domain-list.conf
...
sed "s/^full://g;s/^regexp:.*$//g;s/^/nameserver \//g;s/$/\/proxy/g" -i /tmp/temp_proxy
cat /tmp/temp_proxy > conf/domain-set/proxy-domain-list.conf
